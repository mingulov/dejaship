...
server.registerTool("dejaship_check_airspace", {
  description:
    "Check the semantic neighborhood density for a project idea. RECOMMENDED FIRST STEP: always call this before claiming. Returns density counts and closest active claims with resolution_url for shipped projects.",
  inputSchema: {
